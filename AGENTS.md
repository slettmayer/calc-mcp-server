...
> alters documented behavior, update the matching `docs/` file in the **same PR** — nothing automated
> checks this, so it rests on whoever writes the change (see [docs/README.md](docs/README.md)).
